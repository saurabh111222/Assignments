...
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            if reviews.count() >= int(number): # if there is a collection with searched keyword and it has records in it

                return render_template('results.html',reviews=reviews[0:int(number)]) # show the results to user
            else:
            ...
            return 'Please try again at least 2-3 times if not working.'
